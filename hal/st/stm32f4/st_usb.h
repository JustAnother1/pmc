...
#define USB_OTG_DCFG_DAD_BITMASK                        0x000007f0
#define USB_OTG_DCFG_DAD_OFFSET                         4
...
#define USB_OTG_DCFG_PFIVL_BITMASK                      0x00001800
#define USB_OTG_DCFG_PFIVL_OFFSET                       11
...
#define USB_OTG_DCTL_TCTL_OFFSET                        4
...
#define USB_OTG_DSTS_ENUMSPD_OFFSET                     1
...
#define USB_OTG_DSTS_FNSOF_0                 ((uint32_t)0x00000100)            /*!<Bit 0 */
...
#define USB_OTG_GUSBCFG_TRDT_BITMASK                    0x00003c00
#define USB_OTG_GUSBCFG_TRDT_OFFSET                     10
...
#define USB_OTG_GRSTCTL_TXFNUM_OFFSET                   6
...
#define USB_OTG_GINTSTS_GOUTNAKEFF           ((uint32_t)0x00000080)            /*!< Global OUT NAK effective */
...
#define USB_OTG_GRXSTSP_BCNT_OFFSET                     4
...
#define USB_OTG_GRXSTSP_PKTSTS_OFFSET                   17
...
#define USB_OTG_DIEPCTL_EPTYP_OFFSET                    18
...
#define USB_OTG_DIEPCTL_TXFNUM_OFFSET                    22
...
#define DOEPTSIZ_PKTCNT_OFFSET               19
...
#define DOEPTSIZ_RXDPID_STUPCNT_OFFSET       29

#define BITMASK_DEP0XFRSIZ_XFRSIZ            0x0000007f
#define BITMASK_DEP0XFRSIZ_PKTCNT            0x00180000
#define BITMASK_DEP0XFRSIZ_SUPCNT            0xC0000000
#define DEP0XFRSIZ_PKTCNT_OFFSET             19
#define DEP0XFRSIZ_SUPCNT_OFFSET             30
...
#define USB_OTG_FS_BASE_ADDR                 USB_OTG_FS_PERIPH_BASE
...
{
    void (*Init)(uint8_t cfgidx);
    void (*DeInit)(uint8_t cfgidx);
    /* Control Endpoints*/
    void (*Setup)(USB_SETUP_REQ  *req);
    ...
    void (*SOF)(void);
    void (*IsoINIncomplete)(void);
    void (*IsoOUTIncomplete)(void);
