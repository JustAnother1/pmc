...
/******************************************************************************/
// CPU Clock = 84 MHz
#define FREQUENCY_OF_CPU_CLK 84000000
...
// Flash:
// Wait states (3,3V and 84MHz) RM0368_P46
...
// PLLP = /4 -> Bit 0 ( 00 = /2; 01 = /4; 10 = /6; 11 = /8)
#define RCC_PLL_PLLP  RCC_PLLCFGR_PLLP_0
// PLLN = 336 -> 1 01 01 00 00 -> 4+6+8
...
#define UART_0                     USART1 // -> APB2 -> 84MHz
#define UART_0_BRR                 0x2d9 // 115200 kbit/s
...
#define UART_1                     USART2  // -> APB1 -> 42MHz
#define UART_1_BRR                 0x16d // 115200 kbit/s
