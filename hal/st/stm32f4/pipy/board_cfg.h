...
#define LED_1_RCC_GPIO_ENABLE      RCC_AHB1ENR_GPIOEEN
#define LED_1_MODER_0              GPIO_MODER_15_OUTPUT_0
#define LED_1_MODER_1              GPIO_MODER_15_OUTPUT_1
#define LED_1_OTYPER_0             GPIO_OTYPER_15_PUSH_PULL_0
#define LED_1_OTYPER_1             GPIO_OTYPER_15_PUSH_PULL_1
#define LED_1_OSPEEDR_0            GPIO_OSPEEDER_15_LOW_SPEED_0
#define LED_1_OSPEEDR_1            GPIO_OSPEEDER_15_LOW_SPEED_1
#define LED_1_PUPD_0               GPIO_PUPDR_15_NONE_0
#define LED_1_PUPD_1               GPIO_PUPDR_15_NONE_1
#define LED_1_ODR                  GPIO_ODR_15
#define LED_1_BSRR                 GPIO_BSRR_15
// blue - E10
#define LED_2_GPIO_PORT            GPIOE
#define LED_2_RCC_GPIO_ENABLE      RCC_AHB1ENR_GPIOEEN
#define LED_2_MODER_0              GPIO_MODER_10_OUTPUT_0
#define LED_2_MODER_1              GPIO_MODER_10_OUTPUT_1
#define LED_2_OTYPER_0             GPIO_OTYPER_10_PUSH_PULL_0
#define LED_2_OTYPER_1             GPIO_OTYPER_10_PUSH_PULL_1
#define LED_2_OSPEEDR_0            GPIO_OSPEEDER_10_LOW_SPEED_0
#define LED_2_OSPEEDR_1            GPIO_OSPEEDER_10_LOW_SPEED_1
#define LED_2_PUPD_0               GPIO_PUPDR_10_NONE_0
...
// UART1 = Debug Terminal Interface = Pin PC7(Input) PC6(Output)
...
/*                                                                            */
/******************************************************************************/
// SPI-0 = MISO(PB4), MOSI(PB5), /CS(PA15), SCLK(PB3)
...
// SPI-1 MISO(PC2), MOSI(PC3), /CS(PB12,PE9), SCLK(PB13)
...
#define D_OUT_0_OSPEEDR_1          GPIO_OSPEEDER_0_LOW_SPEED_1
#define D_OUT_0_PUPD_0             GPIO_PUPDR_0_NONE_0
#define D_OUT_0_PUPD_1             GPIO_PUPDR_0_NONE_1
...
#define D_OUT_1_OSPEEDR_1          GPIO_OSPEEDER_1_LOW_SPEED_1
#define D_OUT_1_PUPD_0             GPIO_PUPDR_1_NONE_0
#define D_OUT_1_PUPD_1             GPIO_PUPDR_1_NONE_1
...
#define D_OUT_2_OSPEEDR_1          GPIO_OSPEEDER_2_LOW_SPEED_1
#define D_OUT_2_PUPD_0             GPIO_PUPDR_2_NONE_0
#define D_OUT_2_PUPD_1             GPIO_PUPDR_2_NONE_1
#define D_OUT_2_ODR                GPIO_ODR_2
...
#define D_IN_3_RCC_GPIO_ENABLE     RCC_AHB1ENR_GPIOCEN
#define D_IN_3_GPIO_PORT           GPIOC
#define D_IN_3_MODER_0             GPIO_MODER_13_INPUT_0
#define D_IN_3_MODER_1             GPIO_MODER_13_INPUT_1
#define D_IN_3_OTYPER_0            GPIO_OTYPER_13_OPEN_DRAIN_0
...
#define D_IN_4_RCC_GPIO_ENABLE     RCC_AHB1ENR_GPIOCEN
#define D_IN_4_GPIO_PORT           GPIOC
#define D_IN_4_MODER_0             GPIO_MODER_14_INPUT_0
#define D_IN_4_MODER_1             GPIO_MODER_14_INPUT_1
#define D_IN_4_OTYPER_0            GPIO_OTYPER_14_OPEN_DRAIN_0
...
#define D_IN_5_RCC_GPIO_ENABLE     RCC_AHB1ENR_GPIOCEN
#define D_IN_5_GPIO_PORT           GPIOC
#define D_IN_5_MODER_0             GPIO_MODER_15_INPUT_0
#define D_IN_5_MODER_1             GPIO_MODER_15_INPUT_1
#define D_IN_5_OTYPER_0            GPIO_OTYPER_15_OPEN_DRAIN_0
