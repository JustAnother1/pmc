...
// pull up
#define UART_0_RX_GPIO_PUPD_1      GPIO_PUPDR_PUPDR10_0
#define UART_0_RX_GPIO_PUPD_0      GPIO_PUPDR_PUPDR10_1
...
#define UART_0_TX_GPIO_PUPD_1      GPIO_PUPDR_PUPDR9_0
#define UART_0_TX_GPIO_PUPD_0      GPIO_PUPDR_PUPDR9_1
...
#define UART_1_RX_GPIO_PUPD_1      GPIO_PUPDR_PUPDR7_0
#define UART_1_RX_GPIO_PUPD_0      GPIO_PUPDR_PUPDR7_1
// PC7 = AF8 = 1000
...
#define SPI_0_MISO_GPIO_MODER_1   GPIO_MODER_MODER4_1
#define SPI_0_MISO_GPIO_MODER_0   GPIO_MODER_MODER4_0
#define SPI_0_MISO_GPIO_OTYPER_1  0
#define SPI_0_MISO_GPIO_OTYPER_0  GPIO_OTYPER_OT_4
#define SPI_0_MISO_GPIO_OSPEEDR_1 GPIO_OSPEEDER_OSPEEDR4
#define SPI_0_MISO_GPIO_OSPEEDR_0 0
#define SPI_0_MISO_GPIO_PUPD_1    0
#define SPI_0_MISO_GPIO_PUPD_0    GPIO_PUPDR_PUPDR4
...
#define SPI_0_MOSI_GPIO_MODER_1   GPIO_MODER_MODER5_1
#define SPI_0_MOSI_GPIO_MODER_0   GPIO_MODER_MODER5_0
#define SPI_0_MOSI_GPIO_OTYPER_1  0
#define SPI_0_MOSI_GPIO_OTYPER_0  GPIO_OTYPER_OT_5
#define SPI_0_MOSI_GPIO_OSPEEDR_1 GPIO_OSPEEDER_OSPEEDR5
#define SPI_0_MOSI_GPIO_OSPEEDR_0 0
#define SPI_0_MOSI_GPIO_PUPD_1    0
#define SPI_0_MOSI_GPIO_PUPD_0    GPIO_PUPDR_PUPDR5
...
#define SPI_0_NSS_GPIO_MODER_1    GPIO_MODER_MODER15_1
#define SPI_0_NSS_GPIO_MODER_0    GPIO_MODER_MODER15_0
#define SPI_0_NSS_GPIO_OTYPER_1   0
#define SPI_0_NSS_GPIO_OTYPER_0   GPIO_OTYPER_OT_15
#define SPI_0_NSS_GPIO_OSPEEDR_1  GPIO_OSPEEDER_OSPEEDR15
#define SPI_0_NSS_GPIO_OSPEEDR_0  0
#define SPI_0_NSS_GPIO_PUPD_1     0
#define SPI_0_NSS_GPIO_PUPD_0     GPIO_PUPDR_PUPDR15
#define SPI_0_NSS_GPIO_AFR_0_1    0
#define SPI_0_NSS_GPIO_AFR_0_0    0
#define SPI_0_NSS_GPIO_AFR_1_1    0x50000000
#define SPI_0_NSS_GPIO_AFR_1_0    0xa0000000

#define SPI_0_SCK_GPIO_MODER_1    GPIO_MODER_MODER3_1
#define SPI_0_SCK_GPIO_MODER_0    GPIO_MODER_MODER3_0
#define SPI_0_SCK_GPIO_OTYPER_1   0
#define SPI_0_SCK_GPIO_OTYPER_0   GPIO_OTYPER_OT_3
#define SPI_0_SCK_GPIO_OSPEEDR_1  GPIO_OSPEEDER_OSPEEDR3
#define SPI_0_SCK_GPIO_OSPEEDR_0  0
#define SPI_0_SCK_GPIO_PUPD_1     0
#define SPI_0_SCK_GPIO_PUPD_0     GPIO_PUPDR_PUPDR3
...
#define SPI_1_MISO_GPIO_MODER_1   GPIO_MODER_MODER2_1
#define SPI_1_MISO_GPIO_MODER_0   GPIO_MODER_MODER2_0
#define SPI_1_MISO_GPIO_OTYPER_1  0
#define SPI_1_MISO_GPIO_OTYPER_0  GPIO_OTYPER_OT_2
#define SPI_1_MISO_GPIO_OSPEEDR_1 GPIO_OSPEEDER_OSPEEDR2
#define SPI_1_MISO_GPIO_OSPEEDR_0 0
#define SPI_1_MISO_GPIO_PUPD_1    0
#define SPI_1_MISO_GPIO_PUPD_0    GPIO_PUPDR_PUPDR2
...
#define SPI_1_MOSI_GPIO_MODER_1   GPIO_MODER_MODER3_1
#define SPI_1_MOSI_GPIO_MODER_0   GPIO_MODER_MODER3_0
#define SPI_1_MOSI_GPIO_OTYPER_1  0
#define SPI_1_MOSI_GPIO_OTYPER_0  GPIO_OTYPER_OT_3
#define SPI_1_MOSI_GPIO_OSPEEDR_1 GPIO_OSPEEDER_OSPEEDR3
#define SPI_1_MOSI_GPIO_OSPEEDR_0 0
#define SPI_1_MOSI_GPIO_PUPD_1    0
#define SPI_1_MOSI_GPIO_PUPD_0    GPIO_PUPDR_PUPDR3
...
#define SPI_1_NSS_GPIO_MODER_1    GPIO_MODER_MODER12_1
#define SPI_1_NSS_GPIO_MODER_0    GPIO_MODER_MODER12_0
#define SPI_1_NSS_GPIO_OTYPER_1   0
#define SPI_1_NSS_GPIO_OTYPER_0   GPIO_OTYPER_OT_12
#define SPI_1_NSS_GPIO_OSPEEDR_1  GPIO_OSPEEDER_OSPEEDR12
#define SPI_1_NSS_GPIO_OSPEEDR_0  0
#define SPI_1_NSS_GPIO_PUPD_1     0
#define SPI_1_NSS_GPIO_PUPD_0     GPIO_PUPDR_PUPDR12
#define SPI_1_NSS_GPIO_AFR_0_1    0
#define SPI_1_NSS_GPIO_AFR_0_0    0
#define SPI_1_NSS_GPIO_AFR_1_1    0x00050000
#define SPI_1_NSS_GPIO_AFR_1_0    0x000a0000

#define SPI_1_SCK_GPIO_MODER_1    GPIO_MODER_MODER13_1
#define SPI_1_SCK_GPIO_MODER_0    GPIO_MODER_MODER13_0
#define SPI_1_SCK_GPIO_OTYPER_1   0
#define SPI_1_SCK_GPIO_OTYPER_0   GPIO_OTYPER_OT_13
#define SPI_1_SCK_GPIO_OSPEEDR_1  GPIO_OSPEEDER_OSPEEDR13
#define SPI_1_SCK_GPIO_OSPEEDR_0  0
#define SPI_1_SCK_GPIO_PUPD_1     0
#define SPI_1_SCK_GPIO_PUPD_0     GPIO_PUPDR_PUPDR13
