...
typedef struct
{
    ...
    uint16_t BSRR_SET;   /*!< GPIO port bit set/reset low register,  Address offset: 0x18      */
    uint16_t BSRR_RESET; /*!< GPIO port bit set/reset high register, Address offset: 0x1A      */
...
extern GPIO_TypeDef GPIOH_BASE;
extern GPIO_TypeDef GPIOI_BASE;
